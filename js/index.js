...
var player1 = "Player 1",
    ...
    p1Color = "rgb(124, 159, 209)", // #7C9FD1 rgb(124,159,209)
    p2Color = "rgb(198, 108, 111)",
    noColor = "#FFF",
    slots = document.querySelectorAll(".token-slot"),
  ...
  for (var i = 0, len = g.children.length; i < len; i++) {
    ...
    (function(index){
      ...
      g.children[i].onmouseover = function() {
        var hoverSlots = document.querySelectorAll(".column-hover");
